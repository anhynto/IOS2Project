...
class NetworkManager {
    ...
    func fetchCharacters(completion: @escaping (Result<PageElements<Personnage>, Error>) -> Void) {
        ...
        let task = session.dataTask(with: request) { (data, urlResponse, error) in
            ...
            do {
                ...
                let result = try jsonDecoder.decode(PageElements<Personnage>.self, from: data)
